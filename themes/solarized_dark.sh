...
# Black
COLORS['color0']='#28263b' # base02
COLORS['color8']='#191d29' # base03
# Red
...
# White
COLORS['color7']='#839496' # base0
COLORS['color15']='#93a1a1' # base1

COLORS['foreground']=${COLORS['color15']}
COLORS['foreground_bold']=${COLORS['color7']}
COLORS['cursor']=${COLORS['color7']}
COLORS['cursor_foreground']=${COLORS['color0']}
COLORS['background']=${COLORS['color8']}
